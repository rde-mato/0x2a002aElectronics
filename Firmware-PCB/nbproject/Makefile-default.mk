...
# Source Files
SOURCEFILES=config.c SPI_driver.c UART_driver.c LCD_driver.c I2C_driver.c HT16_leds_driver.c HT16_keys_driver.c EEPROM_driver.c SDCARD_driver.c encoders_driver.c bpm.c input_handler.c LCD_templates.c MIDI.c sequencer.c output_handler.c notes.c mappings.c main.c init.c
